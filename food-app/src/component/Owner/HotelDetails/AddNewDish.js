...
event.preventDefault();
   async function FoodDataSubmit(){
     const data= await fetch(`http://localhost:4000/${Params.hotelid}/adddish`,{
        method:'POST',
        body:JSON.stringify({
            foodname:FoodName,
            foodprice:FoodPrice,
    ...
    <form className='Add-Dish-Form' onSubmit={handleFoodFormSubmit}>
        <div className='Add-Dish-div'>
            <div className='Add-Dish-div1'>
                ...
                <input type='text' value={FoodName} name='foodname' onChange={handleFoodFormChange}></input>
                </div>
                <div className='Add-Dish-div1'>
                <label> Price</label>
                <input type='text' value={FoodPrice} name='foodprice' onChange={handleFoodFormChange}></input>
                </div>
                <div className='Add-Dish-div1'>
                <label> Description</label>
                <input type='text' value={FoodDescription} name='fooddescription' onChange={handleFoodFormChange}></input>
                </div>
                <div className='Add-Dish-div1'>
                <label> Category</label>
                <input type='text' value={FoodCategory} name='food' onChange={handleFoodFormChange}></input>
            </div>
    <div className='Add-Dish-div1'>
                <label>Type</label>
