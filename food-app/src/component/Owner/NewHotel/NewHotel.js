  ...
  return (
    <form className='add-hotel-form' onSubmit={SubmitHotelData}>
        ...
        <div className='add-hotel-div'>
            ...
            <input  className='add-hotel-input' type='text' value={Hotelname}  name='hotelname'onChange={ChangeHotelData}></input>
        </div>
        <div className='add-hotel-div'>
            <label className='add-hotel-label'>City</label>
            <input className='add-hotel-input' type='text' value={City}  name='City' onChange={ChangeHotelData}></input>
        </div>
        <div className='add-hotel-div'>
        ...
        <div className='add-hotel-div'>
            ...
            <input className='add-hotel-input' type='file' value={Image}  name='Image'onChange={ChangeImageData}></input>
        </div>
        </div>
